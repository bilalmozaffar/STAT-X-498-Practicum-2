...
ggplot(dat_mini_1_impute, aes(x = price, y = y)) +
geom_jitter(height = 0.1, width = 0.5) + 
  xlab("Proposed Price for Product") + 
  ylab("Individuals Willing to Buy Product") +
  ggtitle("Figure #: Relationship Between Price and Willingness to Purchase Product")
  ggsave("price_rel_1.jpeg", width = 22, height = 7, dpi = 300)
```
...
ggsave("job_rel_1.jpeg", width = 22, height = 7, dpi = 300)
